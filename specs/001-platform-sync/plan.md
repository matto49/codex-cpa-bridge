...
5. Redesign the Models interaction to show per-platform propagation, pending/reconnect state, errors, and a one-click sync action. Harden loading, empty/error states and repeated clicks.
